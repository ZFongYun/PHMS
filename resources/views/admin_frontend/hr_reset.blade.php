...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">修改成員密碼</h4>
            </div>

            <div class="col-sm-6">
                <div class="card card-color">
                    <div class="card-heading bg-gray">
                        <h3 class="card-title m-0">{{$memberToReset['name']}}</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{route('Overall.hr_reset_update',$memberToReset['id'])}}" method="post">
                            {{ csrf_field() }}
