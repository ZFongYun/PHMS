                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-8">
                                <div class="input-group m-b-5">
                                    <input type="text" class="form-control" placeholder="yyyy-mm-dd" id="datepicker_limit_start" name="limit_start_date" required="">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="yyyy-mm-dd" id="datepicker_limit_end" name="limit_end_date" required="">
                                    <div class="input-group-append m-r-5">
                                        <span class="input-group-text bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
                                    </div>
